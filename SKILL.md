...
Merge renovate pull requests skill

## Description:

This skill is used to attempt to merge in pull requests opened by Renovatebot, but which are not automatically merged.
